...
@section('content')
    ...
    <section class="content">
        <div class="container">
            <form action="{{ url('admin/umum/add-fasilitas') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col">
                    <label for="fac_name" class="form-label">Nama Fasilitas</label>
                    <input type="text" name="fac_name" class="form-control" id="fac_name" required>
                </div>
                
                <div class="mt-3">
                    <button id="btn-tambah-fasilitas" type="submit" class="btn btn-block btn-success">
                        Tambah
                    </button>
                </div>
            </form>
