...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Tambah Source</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container">
            <form action="{{ url('admin/umum/add-maps') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col">
                ...
                <div class="mt-3">
                    <button id="btn-tambah-maps" type="submit" class="btn btn-block btn-success">
                        Tambah
                    </button>
                </div>
            </form>
