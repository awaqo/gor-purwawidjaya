...
@section('content')
    <div class="container container-detail-compe min-vh-100 px-4">
        <a href="{{ route('info-akademi') }}" class="text-decoration-none text-color-secondary poppins-semibold">
        ...
        <div class="d-flex flex-column row-gap-3 mt-4">
                ...
                <div class="d-flex column-gap-4">
                    ...
                    <div class="d-flex flex-column row-gap-2">
                        <div class="col poppins-bold text-color-primary text-capitalize text-compe-title">
                            {{ $detail_academy->coach_name }}
                        </div>
                        <div class="col poppins-semibold text-color-secondary text-capitalize">Pelatih</div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="poppins-regular text-color-secondary fs-6">{{ $detail_academy->coach_profile}}</div>
            </div>
                ...
                <div class="d-flex flex-sm-column flex-md-row flex-wrap my-3 gap-4">
                    ...
                    <div class="d-flex flex-column flex-wrap gap-3">
                        ...
                        <div class="d-flex flex-row column-gap-3">
                            ...
                            <div class="poppins-medium text-color-secondary text-compe-info">Rp {{ number_format($detail_academy->price_academy, 0, ",", ".") }}/bulan</div>
                        </div>
                    </div>
                    {{-- list --}}
                    <div class="d-flex flex-column flex-wrap gap-3">
                        <div class="d-flex flex-row column-gap-3">
                            <div style="width: 24px; height: 24px">
                                <img src="{{ asset('assets/dist/icon/pertemuan.png') }}" class="img-fluid" alt="">
                            </div>
                            <div class="poppins-medium text-color-secondary text-compe-info">{{ $detail_academy->meeting }} Pertemuan</div>
                        </div>
                        ...
                        <div class="d-flex flex-row column-gap-3">
                            ...
                            <div class="poppins-medium text-color-secondary text-compe-info">{{ $detail_academy->time_schedule_start }} - {{ $detail_academy->time_schedule_end }} WIB</div>
                        </div>
                    </div>
                    {{-- list --}}
                    <div class="d-flex flex-column flex-wrap gap-3">
                        <div class="d-flex flex-row column-gap-3">
                            ...
                            <div class="poppins-medium text-color-secondary text-compe-info">{{ $detail_academy->difficulty_academy }}</div>
                        </div>
                        ...
                        <div class="d-flex flex-row column-gap-3">
                            ...
                            <div class="poppins-medium text-color-secondary text-compe-info">{{ $detail_academy->slot_academy }} orang/pertemuan</div>
                        </div>
                    </div>
                    {{-- list --}}
                    <div class="d-flex flex-column flex-wrap gap-3">
                        <div class="d-flex flex-row column-gap-3">
                            ...
                            <div class="poppins-medium text-color-secondary text-compe-info">{{ $detail_academy->location_academy }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center mt-5">
                ...
                <button type="button" class="join-now poppins-semibold text-center text-decoration-none px-4 py-3 rounded-5" data-bs-toggle="modal" data-bs-target="#joinAcademy">
                    Hubungi Sekarang
                </button>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="joinAcademy" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="joinAcademyLabel" aria-hidden="true">
